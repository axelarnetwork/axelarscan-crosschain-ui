...
export const PageWithText = ({
  ...
  inactiveClassNames = 'btn btn-default bg-gray-100 hover:bg-gray-200 dark:bg-gray-900 dark:hover:bg-gray-800 text-gray-500 hover:text-gray-700 dark:hover:text-gray-100',
  disabled = false,
  active,
  onClick,
  children,
